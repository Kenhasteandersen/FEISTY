  ...
  useShinyjs(),
    ...
    sidebarLayout(
        sidebarPanel(
          ...
          radioButtons("Setup", 
                       ("Setup"),
                       choices = list("SetupBasic" = "setupBasic", "SetupBasic2" = "setupBasic2", 
                                      "SetupVertical (no bprod input)" = "setupVertical",
                                      "SetupVertical2 (no bprod input)" = "setupVertical2"),
                       selected = "setupBasic" ,inline = TRUE),
          radioButtons("region", 
                       ("Region (Temp. profile)"),
