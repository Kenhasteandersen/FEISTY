...
According to different functional types of fish and their sizes, fish habitats change. For fish staying in the pelagic zone, $T=T_p$ (e.g., all forage fish); for fish always in benthic zone $T=T_b$ (e.g., medium-size demersal fish). Detail can be found in 
...
Therefore, the temperature for large demersal is defined based on the their time spent in pelagic zone and benthic zone, which is called effective temperature:
\begin{equation} 
