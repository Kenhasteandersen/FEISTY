...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/e35ae15ab7eb4b96b82a6d6a1c9a091d002c6ca9.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/aec9afd298a6b0ce8f201e53ca5e32b7e0a00586.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/f7042719a62452e24a6e214dfc0595f8d9e18da9.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/7ae3724252ad65ae667cd5084132aba73e5d8f47.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/e048471cad4444f81e21d3bcbbbf08104d456962.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/0be8ee097e60112b4b686c4665140ffa51dacc82.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/26f0c03ecc0c98379a693ebe24f043f7d903eef3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/7209d530663af0e41c3fca52983366359c060c1e.pdf}}

\section{Time-series simulation}\label{time-series-simulation}

The version 1.1 of the FEISTY package provides functions allowing the
...
data, which is limited by the carrying capacity (\(K_i\), set by users):

\begin{equation}
\frac{\mathrm{d}R_i}{\mathrm{d}t}=r_i \cdot (1-\frac{R_i}{K_i}) - \mu_{\mathrm{p},i} \cdot R_i .
\end{equation}

Note, this is slightly different from Eq. \ref{eq:dRdtlogistic}. The
\(r_i\) in Eq. \ref{eq:dRdtlogistic} is the growth rate in the unit of
per time, while the \(r_i\) here represents the production
(biomass/area/time).
...
(\(P_{\mathrm{R},j}\), in mass/area/time). If the total consumption by
all fish, as calculated by the product of predation mortality on
zooplankton and zooplankton biomass (\(\mu_{\mathrm{p},j} R_j\), in
mass/area/time) exceeds the resource production, the consumption of the
resource has to be down-regulated.
...
\(f_{\mathrm{dr},j}\), and henceforth several variable changes. The
total consumption rate of a resource prey \(j\) by all predators is
equal to the predation mortality rate of that prey (Eq.
\ref{eq:predationmortality}). The predation mortality rate of a prey
\(j\) is updated by multiplying the down-regulation factor
\(f_{\mathrm{dr},j}\):

\begin{equation}
\mu_{\mathrm{p},j} = f_{\mathrm{dr},j} \sum_i  \frac{V_i \theta_{i,j}}{E_i+C_{\mathrm{max},i}} C_{\mathrm{max},i} B_i,
\end{equation} where \(E_i\) is the mass-specific encounter rate of a
predator \(i\), and \(j\) denotes indices of prey including all
resources and fish. The down-regulation factor \(f_{\mathrm{dr},j}\) is
the ratio of the resource production and resource predation loss:
...
\max\{1, \, \frac{P_{\mathrm{R},j}}{\mu_{\mathrm{p},j} R_j} \},      & \text{$ j \in \mathrm{resource\ requiring\ down}-\mathrm{regulation} $} \\
  ...
  \end{cases}
\end{equation} For the other prey whose predation loss do not need
down-regulation, the factor is 1 to keep everything unchanged.
...
\end{equation} This procedure ensures that mass is not created in the
system. However, it does not ensure perfect mass balance. If the fish
predators do not eat all the zooplankton production, there is an
``excess'' zooplankton production which is not accounted for. Further,
as mentioned above, the fish are not allowed to compensate for the
reduction in zooplankton consumption by an increase in consumption of
other prey. We believe that this latter assumption has a quite small
impact.
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ diagts, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ t, }\AttributeTok{y =}\NormalTok{ val, }\AttributeTok{color =}\NormalTok{ group, }\AttributeTok{group =}\NormalTok{ group)) }\SpecialCharTok{+}
    ...
    \CommentTok{\#scale\_y\_log10(breaks = trans\_breaks("log10", function(x) 10\^{}x),}
    \CommentTok{\#              labels = trans\_format("log10", math\_format(10\^{}.x))) +}
    \FunctionTok{scale\_y\_log10}\NormalTok{(}
    \AttributeTok{breaks =}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{breaks\_log}\NormalTok{(}\AttributeTok{n =} \DecValTok{5}\NormalTok{, }\AttributeTok{base =} \DecValTok{10}\NormalTok{),}
    \AttributeTok{labels =}\NormalTok{ scales}\SpecialCharTok{::}\FunctionTok{label\_log}\NormalTok{(}\AttributeTok{base =} \DecValTok{10}\NormalTok{)}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/87aa661cf669105d8722c45d79e99e8d1e3b21a2.pdf}}
...
This ``drifting apart'' of the solutions is not an error but is due to
the sometimes chaotic nature of the solution of the ODE system. The
solutions are not always chaotic (for instance, the first case). The
fact that the solutions may be chaotic shows the limitation of what we
can expect the model to predict: we can predict average values, but not
the accurate time trajectory of any of the species groups.
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/49798554ff0301ca441004667f4e7736df390b38.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/2763f88cfe2d18c464d37ad06a6b158ce91fa79c.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{/Users/kenhasteandersen/Documents/Undervisning/FEISTY course/FEISTY/vignettes/FEISTY_files/74103ec9839fe84bf1ab4322d13fb1544a34b65a.pdf}}
