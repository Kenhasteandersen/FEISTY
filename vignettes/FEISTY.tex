...
\includegraphics{C:/Users/Admin/Desktop/feistyts/FEISTY/vignettes/FEISTY_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\includegraphics{C:/Users/Admin/Desktop/feistyts/FEISTY/vignettes/FEISTY_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{C:/Users/Admin/Desktop/feistyts/FEISTY/vignettes/FEISTY_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\includegraphics{C:/Users/Admin/Desktop/feistyts/FEISTY/vignettes/FEISTY_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\includegraphics{C:/Users/Admin/Desktop/feistyts/FEISTY/vignettes/FEISTY_files/figure-latex/unnamed-chunk-8-1.pdf}
...
\includegraphics{C:/Users/Admin/Desktop/feistyts/FEISTY/vignettes/FEISTY_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{C:/Users/Admin/Desktop/feistyts/FEISTY/vignettes/FEISTY_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\includegraphics{C:/Users/Admin/Desktop/feistyts/FEISTY/vignettes/FEISTY_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\hypertarget{time-series-input}{%
\section{Time-series input}\label{time-series-input}}

The FEISTY model can be coupled with datasets or other model products
that provide time-series inputs, of temperature, zooplankton biomass,
zooplankton production, and benthic production. To avoid creation of new
mass in the model, the consumption by the fish predators must not exceed
the corresponding zooplankton production (\(P_{\mathrm{R},j}\), in
mass/area/time). If the consumption, as calculated by the encounter with
zooplankton (\(\mu_{\mathrm{p},j} R_j\)) exceeds the resource
production, the consumption of the resource has to be down-regulated.

When consumption of one food item (here the resource) is decreased the
predator can compensate by eating more of other resource. For
simplicity, however, we assume that only the resource consumption is
decreased, and the consumption of other prey is not increased to
compensate. To follow this assumption, we introduce a down-regulation
factor \(f_{\mathrm{dr},j}\) and henceforth several variables change.
The total consumption of all predators of the resource prey \(j\) is
equal to the predation mortality loss of that prey (Eq.
